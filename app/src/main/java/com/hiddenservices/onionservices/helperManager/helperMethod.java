...
public class helperMethod {
    ...
    public static String getAssetsCacheFile(Context context, String fileName) {
        ...
        if(status.sSettingTrackingProtection==ContentBlocking.AntiTracking.STRICT){
            ...
            mYAML = mYAML.replace("# webgl.min_capability_mode: false", "webgl.min_capability_mode: true");
            mYAML = mYAML.replace("# webgl.disable-extensions: false", "webgl.disable-extensions: true");
            mYAML = mYAML.replace("# browser.display.use_document_fonts: 0", "browser.display.use_document_fonts: 0");
            mYAML = mYAML.replace("# media.autoplay.default: 0", "media.autoplay.default: 5");
            mYAML = mYAML.replace("# layers.acceleration.disabled: false", "layers.acceleration.disabled: true");
            ...
            mYAML = mYAML.replace("# network.dns.disablePrefetch: false", "network.dns.disablePrefetch: true");
            ...
            mYAML = mYAML.replace("# browser.download.folderList: 1", "browser.download.folderList: 2");
            mYAML = mYAML.replace("# webgl.enable-webgl2: false", "webgl.enable-webgl2: false");
            mYAML = mYAML.replace("# webgl.disabled: false", "webgl.disabled: true");
        }
        if(status.sSettingTrackingProtection==ContentBlocking.AntiTracking.DEFAULT){
            mYAML = mYAML.replace("# javascript.enabled: false", "javascript.enabled: true");
            ...
            mYAML = mYAML.replace("# media.peerconnection.enabled: false", "media.peerconnection.enabled: true");
            mYAML = mYAML.replace("# media.autoplay.default: 0", "media.autoplay.default: 0");
            mYAML = mYAML.replace("# dom.w3c_touch_events.enabled: 0", "dom.w3c_touch_events.enabled: 1");
            mYAML = mYAML.replace("# dom.event.clipboardevents.enabled: false", "dom.event.clipboardevents.enabled: true");
            mYAML = mYAML.replace("# dom.webnotifications.enabled: false", "dom.webnotifications.enabled: true");
            mYAML = mYAML.replace("# network.prefetch-next: false", "network.prefetch-next: true");
            mYAML = mYAML.replace("# network.dns.disablePrefetch: false", "network.dns.disablePrefetch: false");
            mYAML = mYAML.replace("# network.http.speculative-parallel-limit: 0", "network.http.speculative-parallel-limit: 6");
            mYAML = mYAML.replace("# browser.formfill.enable: false", "browser.formfill.enable: true");
            mYAML = mYAML.replace("# browser.download.folderList: 1", "browser.download.folderList: 1");
            mYAML = mYAML.replace("# webgl.enable-webgl2: false", "webgl.enable-webgl2: true");
            mYAML = mYAML.replace("# dom.battery.enabled: false", "dom.battery.enabled: true");
            mYAML = mYAML.replace("# dom.gamepad.enabled: false", "dom.gamepad.enabled: true");
            mYAML = mYAML.replace("# media.webspeech.synth.enabled: false", "media.webspeech.synth.enabled: true");
        }
