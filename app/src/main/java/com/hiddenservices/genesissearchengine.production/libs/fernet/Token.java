...
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.cipherTextBlockSize;
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.initializationVectorBytes;
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.minimumTokenBytes;
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.signatureBytes;
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.supportedVersion;
import static com.hiddenservices.genesissearchengine.production.libs.fernet.Constants.tokenStaticBytes;
...
public class Token {
     ...
     */
    public static Token generate(final com.hiddenservices.genesissearchengine.production.libs.fernet.Key key, final String plainText) {
     ...
     * @return a unique Fernet token
     */
    public static Token generate(final SecureRandom random, final com.hiddenservices.genesissearchengine.production.libs.fernet.Key key, final String plainText) {
     ...
     * @return a unique Fernet token
     */
    public static Token generate(final com.hiddenservices.genesissearchengine.production.libs.fernet.Key key, final byte[] payload) {
     ...
     * @return a unique Fernet token
     */
    public static Token generate(final SecureRandom random, final com.hiddenservices.genesissearchengine.production.libs.fernet.Key key, final byte[] payload) {
    ...
    public byte[] validateAndDecrypt(final com.hiddenservices.genesissearchengine.production.libs.fernet.Key key) {
